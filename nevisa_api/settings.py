"""
Django settings for nevisa_api project.
...
WSGI_APPLICATION = 'nevisa_api.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'NEVISA',
    'DESCRIPTION': 'Convert audio to text (persian)',
    'VERSION': '1.0.0',
